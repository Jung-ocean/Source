...
# ========================== Globals ========================== #
# Main Paths:
RunDir = '/data/jungjih/Models/SCHISM/test_schism/v1_SMS_min_5m/'
# Path to inputs:
Base_Domain = RunDir
hgridFileName =  'hgrid.gr3'
# Path to outputs:
SCHISM_RunDir = RunDir+'/gen_input/'
case_tag = 'v1_SMS_min_5m'
...
vgrid_type = '2D'  # vertical coordinate case (2D, SZ, or LSC2)
N_vert_lyr = 20  # number of vertical layers if 3D

baro_type = 'barotropic' # options: baroclinic (default), barotropic
