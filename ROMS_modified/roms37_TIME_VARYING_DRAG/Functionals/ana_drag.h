...
!
!! svn $Id: ana_drag.h 937 2019-01-28 06:13:04Z arango $
!!======================================================================
...
# elif defined UV_LDRAG
      ...
      END DO
!-----  20210625 J.Jung
# elif defined UV_QDRAG && defined TIME_VARYING_DRAG
      CALL caldate (tdays(ng), yd_dp=yday)
!       DO j=JstrT,JendT
!         DO i=IstrT,IendT
!           rdrag2(i,j)=0.003_r8-(0.003_r8-0.0006_r8)*DEXP(-((yday-195.0_r8)/90.0_r8)**2)
!         END DO
!       END DO
      rdrag2=0.003_r8-(0.003_r8-0.0006_r8)*DEXP(-((yday-195.0_r8)/90.0_r8)**2)
