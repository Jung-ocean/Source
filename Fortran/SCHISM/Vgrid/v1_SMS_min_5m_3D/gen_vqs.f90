...
!     Read  vgrid.in
      ...
      m_vqs=11
      dz_bot_min=1.0 !min. bottom layer thickness [m]
      allocate(hsm(m_vqs),nv_vqs(m_vqs),a_vqs(m_vqs))
      hsm=(/50.,100.,200.,500.,1.e3,1.5e3,2.5e3,3.e3,3.5e3,4.e3,8.e3/) !.,2000.,1.1e4/)
      nv_vqs=(/30,30,30,33,36,39,42,43,44,45,45/) !# of levels for each master grid (increasing with depth)
!      nv_vqs(6)=nv_vqs(5)+9
!      nv_vqs(7)=nv_vqs(6)+5
!      nv_vqs(8)=nv_vqs(7)+7
