function A=coare30vn(u,v,zu,t,zt,rh,zq,P,ts,Rs,Rl,lat,zi,zref_u,zref_t,zref_q,U10n)
%
...
A=[usr tau hsb hlb hbb hsbb tsr qsr zo zot zoq Cd Ch Ce L zet dter tkt Urf Trf Qrf RHrf rhoa];   
