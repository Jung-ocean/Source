function [h]=arrows_w(x,y,w,fac,color)
...
%HEADA=10*pi/180; HEADL=.75; % Original
HEADA=0.1*pi/180; HEADL=.75; % Jihun's choice
z=x(:)+i*y(:);
...
h=line(real(wplot),imag(wplot),'color',color, 'linewidth', 1.2); % Jihun's choice
