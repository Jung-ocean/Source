...
for yi = 1:length(yyyy_all)
    ...
    if yi ~= 1
        ...
        plabel('FontSize', label_FS);
    end
    mlabel('FontSize', label_FS);
...
ddd
if remove_climate == 1
    exportgraphics(gcf,'SSSA_SMAP_SMOS_ROMS.tif','Resolution',300) 
else
    ...
    exportgraphics(gcf,'SSS_SMAP_SMOS_ROMS.tif','Resolution',300) 
end