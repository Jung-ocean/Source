%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Plot sea ice thickness (ROMS) with ice velocity (ROMS) 
% and wind (ERA5) daily
%
% J. Jung
%
...
cutoff_hice = 0.1;
unit = ['m'];
savename = 'hice_w_uvice_wind';

h1 = figure;
set(gcf, 'Position', [1 200 1500 450])
t = tiledlayout(1,4);
title(t, ['Sea ice thickness (color) with sea ice velocity (red) and 10 m wind (black)'], 'FontSize', 20);
...
for yi = 1:length(yyyy_all)
    ...
    uice_rho(hice < cutoff_hice) = NaN;
    vice_rho(hice < cutoff_hice) = NaN;
...
% Make gif
gifname = [savename, '_', mstr, '_daily.gif'];
