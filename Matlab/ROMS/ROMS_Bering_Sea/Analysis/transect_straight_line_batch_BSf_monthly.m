...
file_i.yyyy = yyyy;
file_i.filepath = '/data/jungjih/ROMS_BSf/Output/Multi_year/Dsm2_spng/monthly/';
...
Rvarname={'u',   'v',  'temp', 'salt', 'w',   'zeta', 'aice', 'sustr', 'svstr'};
varDim=[   3      3     3       3       3      2       2       2        2];
RvarDim={ 'u3d', 'v3d','r3d',  'r3d',  'w3d', 'r2d',  'r2d',  'u2d',   'v2d'};
