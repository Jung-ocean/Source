...
filepaths_sat = {filepath_RSS_70, filepath_RSS_40, filepath_JPL, filepath_OISSS};

lons_sat = {'lon', 'lon', 'longitude', 'longitude'};
lons_360ind = [360, 360, 0, 180];
lats_sat = {'lat', 'lat', 'latitude', 'latitude'};
varis_sat = {'sss_smap', 'sss_smap_40km', 'sss', 'sss'};
titles_sat = {'RSS SMAP L3 SSS v5.3 8-day MA (70 km)', 'RSS SMAP L3 SSS v5.3 8-day MA (40 km)', 'JPL SMAP L3 SSS v5.0 8-day MA (60 km)', 'OISSS L4 v2.0 7-day decorr time scale'};
