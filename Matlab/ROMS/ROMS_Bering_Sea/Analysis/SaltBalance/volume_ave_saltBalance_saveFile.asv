...
avg_fileHead=['./' ExpID '_dia/Winter_2020_Dsm2_spng_avg_'];
his_fileHead=['./' ExpID '_dia/Winter_2020_Dsm2_spng_his_'];
dia_fileHead=['./' ExpID '_dia/Winter_2020_Dsm2_spng_dia_'];
