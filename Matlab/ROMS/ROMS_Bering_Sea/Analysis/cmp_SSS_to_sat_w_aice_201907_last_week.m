...
filepath = ['/data/jungjih/ROMS_BSf/Output/Multi_year/', exp, '/SSSA/vs_sat_4years/last_week_July_2019/'];
...
for yi = 1:1%length(yyyy_all)
    yyyy = yyyy_all(yi); ystr = num2str(yyyy);
    title_str = datestr(datenum(yyyy,mm,1), 'mmm, yyyy');

    filename = [exp, '_201907_last_week.nc'];
    ...
    si = 2;
    % CEC SMOS v9.0
    filepath_CEC = ['/data/jungjih/Observations/Satellite_SSS/Global/CEC/v9/last_week_of_July_2019/'];

    % Satellite
    filepath_sat = filepath_CEC;
    filename_sat = ['SMOS_L3_DEBIAS_LOCEAN_AD_201907_last_week_EASE_09d_25km_v09.nc'];
...
print(['cmp_', savename, '_', mstr, '_with_aice_', msistr, '_201907_last_week'],'-dpng');