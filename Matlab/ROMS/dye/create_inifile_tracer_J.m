function create_inifile_tracer_J(inifile,gridfile,title,...
...
sc_r_ID = netcdf.defVar(ncid, 'sc_r', 'double', sc_r_dimID);
Cs_r_ID = netcdf.defVar(ncid, 'Cs_r', 'double', sc_r_dimID);
...
u_ID = netcdf.defVar(ncid, 'u', 'double', [xi_u_dimID eta_u_dimID sc_r_dimID time_dimID]);
v_ID = netcdf.defVar(ncid, 'v', 'double', [xi_v_dimID eta_v_dimID sc_r_dimID time_dimID]);
...
temp_ID = netcdf.defVar(ncid, 'temp', 'double', [xi_rho_dimID eta_rho_dimID sc_r_dimID time_dimID]);
salt_ID = netcdf.defVar(ncid, 'salt', 'double', [xi_rho_dimID eta_rho_dimID sc_r_dimID time_dimID]);
dye01_ID = netcdf.defVar(ncid, 'dye_01', 'double', [xi_rho_dimID eta_rho_dimID sc_r_dimID time_dimID]);
dye02_ID = netcdf.defVar(ncid, 'dye_02', 'double', [xi_rho_dimID eta_rho_dimID sc_r_dimID time_dimID]);
dye03_ID = netcdf.defVar(ncid, 'dye_03', 'double', [xi_rho_dimID eta_rho_dimID sc_r_dimID time_dimID]);
%
%  Create attributes
%
...
%
netcdf.putAtt(ncid, dye01_ID, 'long_name', 'dye01 concentration');
netcdf.putAtt(ncid, dye01_ID, 'unit', 'kg meter-3');
%
netcdf.putAtt(ncid, dye02_ID, 'long_name', 'dye02 concentration');
netcdf.putAtt(ncid, dye02_ID, 'unit', 'kg meter-3');
%
netcdf.putAtt(ncid, dye03_ID, 'long_name', 'dye03 concentration');
netcdf.putAtt(ncid, dye03_ID, 'unit', 'kg meter-3');
%
