...
[z_amp,z_phase,Depth,conList]=tmd_extract_HC(model_file,lat,lon,vars{1},1:ncon);
[u_amp,u_phase,Depth,conList]=tmd_extract_HC(model_file,lat,lon,vars{2},1:ncon);
[v_amp,v_phase,Depth,conList]=tmd_extract_HC(model_file,lat,lon,vars{3},1:ncon);

conList = conList(1:ncon,:);
