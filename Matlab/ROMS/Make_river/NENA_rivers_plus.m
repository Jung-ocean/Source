...
% roms grid
grd_file = '/home/paulg/roms2p1/grids/roms_nena_grid_6.nc';
N = 30; % Number of vertical levels

% the new netcdf forcing file - river data will be appended
Fname = '/home/paulg/roms/rivers/roms_nena_rivers_plus.nc'; 

% load the river flow data structure
Rname = '/home/paulg/roms/rivers/NENA_rivers_subset_+_Belle_Isle';
load(Rname)
if ~exist('River')
