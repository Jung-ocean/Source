function ROMS_plot_current_with_bar_function(filename, variname_u, variname_v, layer_ind, casename, domain_case, linewidth)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if layer_ind > 0
    ...
    wbar = (ubar_rho+sqrt(-1).*vbar_rho).*g.mask_rho;
    ...
    h1 = m_psliceuv(g.lon_rho,g.lat_rho,wbar,puv.interval, puv.scale_factor,[0.8510 0.3294 0.1020]);
    set(h1,'linewidth', linewidth)
