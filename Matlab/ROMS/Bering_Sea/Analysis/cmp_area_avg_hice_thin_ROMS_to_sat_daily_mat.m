...
load(['/data/jungjih/Observations/Sea_ice/Thin_ice/', region, '/hi_thin_combined_', region, '_daily.mat'])
...
if isROMS == 1
    ...
    l = legend([po, pm2, pm, pc], 'Observation (SMOS & SMAP)', 'Model (ROMS control)', 'Model (ROMS LCda)', 'Model (CICE)');
    l.FontSize = 15;
end
