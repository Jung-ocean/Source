%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Calculate ice momentum balance using history file
%
% J. Jung
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     sustr_aw = (1-aice_u).*rhoair.*cd.*Uwind_u.*Wspeed_u;
    ...
    disp(datestr(timenum(di), 'yyyymmdd ...'))
end
end
