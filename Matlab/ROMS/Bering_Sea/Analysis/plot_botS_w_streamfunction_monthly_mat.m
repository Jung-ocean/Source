%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Plot ROMS botS with streamfunction monthly using .mat files
%
% J. Jung
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
climit = [31.5 33.5];
unit = '^oC';
savename = 'botS_w_streamfunction';
text1_lat = 65.9;
text1_lon = -184.8;
text2_lat = 65.9;
text2_lon = -178;
...
t = tiledlayout(1,4);
% Figure title
title(t, ['Bottom S with streamfunction (interval = 0.1 Sv)'], 'FontSize', 20);
