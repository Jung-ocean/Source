%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Plot ROMS SST with streamfunction monthly using .mat files
%
% J. Jung
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
t = tiledlayout(1,4);
% Figure title
title(t, ['SST with streamfunction (interval = 0.1 Sv)'], 'FontSize', 20);
...
for yi = 1:length(yyyy_all)
    ...
    vari = squeeze(ncread(file, 'temp', [1 1 g.N 1], [Inf Inf 1 Inf]))';
