function data=ext_data_OGCM_MyOcean(nc,X,Y,vname,tndx,lon,lat,k,missvalue,Roa,interp_method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
default = 0;
if strcmp(vname,'so') | strcmp(vname,'salt') | strcmp(vname,'SALT')
    default = 34.6;
end
%
...
data_add_offset = nc{vname}.add_offset(:);
data_scale_factor = nc{vname}.scale_factor(:);
data = data.*data_scale_factor + data_add_offset;
