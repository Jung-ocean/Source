...
ROMS_title  = 'Auto NWP';
ROMS_config = 'Auto NWP';

OGCM_path = 'D:\Data\Ocean\Model\GLORYS_climatology\';
%OGCM_prefix = 'mercatorglorys12v1_gl12_mean_';
OGCM_prefix = 'mercatorglorys12v1_gl12_mean_1993_2016';
...
%
% Get the OGCM grid
grid_name = [OGCM_path, OGCM_prefix, '_', num2char(Mmin,2), '.nc'];
nc = netcdf(grid_name);
LAT = nc{'latitude'}(:);
LON = nc{'longitude'}(:);
lonT = LON; latT = LAT;
...
for Y = Ymin:Ymax
    ...
    for M = mo_min:mo_max
        ...
        for tndx_OGCM = 1:ntimes
            ...
            interp_OGCM_GLORYS(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
