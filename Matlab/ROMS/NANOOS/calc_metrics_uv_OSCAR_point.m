%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Calculate uv metrics of NANOOS and WCOFS models
%
% J. Jung
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
filepath_obs = '/data/jungjih/Observations/Surface_current/OSCAR/daily/';

vari_obs_all = NaN([length(timenum), 31, 37]);
vari_NANOOS_all = NaN([length(timenum), 31, 37]);
vari_WCOFS_all = NaN([length(timenum), 31, 37]);
for di = 1:length(timenum)
    ...
    % Obs
    filename_obs = ['oscar_currents_interim_', yyyymmdd, '.nc'];
    ...
    vari_obs_tmp = 100.*ncread(file_obs, vari_str)'; % m/s to cm/s
...
save(['metrics_', vari_str, '_OSCAR_point.mat'], ...
