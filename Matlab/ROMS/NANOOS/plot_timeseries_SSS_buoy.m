...
l = legend([pn, pw, po], ...
    ['OSU ROMS (', ... 
    'bias = ', num2str(bias_NANOOS, '%.2f'), ' psu, ', ...
    'RMSE = ', num2str(rmse_NANOOS, '%.2f'), ' psu, ', ...
    'corr coef = ', num2str(corrcoef_NANOOS, '%.2f'), ')'], ...
    ['WCOFS (', ...
    'bias = ', num2str(bias_WCOFS, '%.2f'), ' psu, ', ...
    'RMSE = ', num2str(rmse_WCOFS, '%.2f'), ' psu, ', ...
...
print(['timeseries_SSS_buoy'], '-dpng')