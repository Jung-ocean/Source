%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%       Make ROMS forcing using the ECMWF data (Pressure)
%       J. Jung
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fname = ['ECMWF_Interim_msl_', tys, '.nc'];
...
for i = 1:length(time_forcing)
    ...
    Zi = squeeze(vari_mbar(tindex,index_lat,index_lon));
