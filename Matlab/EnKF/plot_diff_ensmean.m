...
for i = 1:exp_step
    ...
    cnc = netcdf([controlpath, 'his_ensmean', '_', num2char(filenum(i), 4), '.nc']);
    anc = netcdf([adapath, 'his_ensmean', '_', num2char(filenum(i), 4), '.nc']);
...
save rms_1_ensmean.mat ada_rms_all bda_rms_all err_diff_sum_all