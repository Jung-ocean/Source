...
save(['harmonic_constants_BSm_bt_', ystr, '.mat'], 'stations', 'names', 'constituents', 'timenum', 'depth', 'u', 'ubar', 'ubar_freq', 'ubar_amp', 'ubar_pha', 'ubar_predict', 'v', 'vbar', 'vbar_freq', 'vbar_amp', 'vbar_pha', 'vbar_predict')