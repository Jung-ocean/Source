...
filepath_median = '/data/jungjih/Observations/Sea_ice/NSIDC/shapefiles/shp_median/';
...
for yi = 1:length(yyyy_all)
    ...
    for mi = 1:length(mm_all)
        ...
        date_title = datestr(datenum(yyyy,mm,1), 'mmm yyyy');
        ...
        title(['Monthly sea ice extent, ', date_title], 'FontSize', 15);
