function [params, logisticfun] = calc_LR(xdata, y, isplot)

% 2D classification using Logistic regression
% Adapted from Dr. Kendrick Kay's MATLAB example (see below)
% https://www.cmrr.umn.edu/~kendrick/statsmatlab/MatlabExamples4.pdf
